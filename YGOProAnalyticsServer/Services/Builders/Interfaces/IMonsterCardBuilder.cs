...
namespace YGOProAnalyticsServer.Services.Builders.Interfaces
{
    ...
    {
        MonsterCardBuilder AddBasicMonsterElements(int passCode, string name, string description, string type, string race, string imageUrl, string smallImageUrl, string attack, string defence, int levelOrRank, string attribute, Archetype archetype);
